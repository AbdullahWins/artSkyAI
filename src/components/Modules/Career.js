...
const Career = () => {
  ...
  const handleClick = () => {
    ...
    const prompt =
      "I want you to act as a career counselor. Provide step by step career advancement advice and give a table in the end to sum up on the given career name. Here is the career name: ";
    setIsLoading(true);
